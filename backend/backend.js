...
const socket = ioClient.connect("http://0.0.0.0:7006"); 
...
io.on("connection", (client) => {
  ...
  client.on("send_audio", async (data) => {
    try {
      ...
      let backUrl = "http://0.0.0.0:8003/chatbot"; // Ensure this matches the Python backend route
